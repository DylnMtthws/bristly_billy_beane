...
constraints:
  ...
  deck_build_limits: "None. The Deck Lab refactor retires per-user monthly build quotas, their UI and admin/CLI controls (owner decision 2026-09-06). Existing database quota values are inert compatibility data."
...
| ADR-017 | Per-user deck quota retired by the owner on 2026-09-06; global model spend ceiling retained | Manual Deck Lab builds have no monthly count limit. Historical quota fields are unused; model-call spend protection is independent. |
...
status:
  ...
  current_phase: "Cloud alignment W1..W9 complete; deployment is a separate, deliberate phase"

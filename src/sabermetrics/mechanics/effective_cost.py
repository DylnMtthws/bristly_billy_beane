...
def compute_effective_cmc(card: dict) -> float:
    ...
    # float(): the dicts are loosely typed, and this module no longer sits
    # under the analytics ignore_errors baseline that used to hide it.
    min_alt = min(float(alt["cmc"]) for alt in alternatives)
